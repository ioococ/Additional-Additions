package dqu.additions;

import com.google.common.collect.ImmutableSet;
import com.mojang.serialization.Codec;
import dqu.additions.block.CopperPatinaBlock;
import dqu.additions.block.GlowStickBlock;
import dqu.additions.block.PatinaBlock;
import dqu.additions.block.RopeBlock;
import dqu.additions.enchantment.PrecisionEnchantment;
import dqu.additions.enchantment.SpeedEnchantment;
import dqu.additions.entity.GlowStickEntity;
import dqu.additions.item.*;
import dqu.additions.material.GildedNetheriteArmorMaterial;
import dqu.additions.material.GildedNetheriteToolMaterial;
import dqu.additions.material.RoseGoldArmorMaterial;
import dqu.additions.material.RoseGoldToolMaterial;
...
public class AdditionalRegistry {
    // Registries
    public static final DeferredRegister<Item> ITEMS = DeferredRegister.create(ForgeRegistries.ITEMS, Additions.namespace);
    public static final DeferredRegister<Block> BLOCKS = DeferredRegister.create(ForgeRegistries.BLOCKS, Additions.namespace);
    public static final DeferredRegister<Enchantment> ENCHANTMENTS = DeferredRegister.create(ForgeRegistries.ENCHANTMENTS, Additions.namespace);
    public static final DeferredRegister<EntityType<?>> ENTITIES = DeferredRegister.create(ForgeRegistries.ENTITY_TYPES, Additions.namespace);
    public static final DeferredRegister<SoundEvent> SOUND_EVENTS = DeferredRegister.create(ForgeRegistries.SOUND_EVENTS, Additions.namespace);
    public static final DeferredRegister<Potion> POTIONS = DeferredRegister.create(ForgeRegistries.POTIONS, Additions.namespace);
    public static final DeferredRegister<PoiType> POIS = DeferredRegister.create(ForgeRegistries.POI_TYPES, Additions.namespace);
    public static final DeferredRegister<Codec<? extends IGlobalLootModifier>> LOOT_MODIFIERS = DeferredRegister.create(ForgeRegistries.Keys.GLOBAL_LOOT_MODIFIER_SERIALIZERS, Additions.namespace);
    ...
    // Sound Events
    private static final SoundEvent U_SOUND_EVENT_0308 = SoundEvent.createVariableRangeEvent(new ResourceLocation(Additions.namespace, "0308"));
    private static final SoundEvent U_SOUND_EVENT_1007 = SoundEvent.createVariableRangeEvent(new ResourceLocation(Additions.namespace, "1007"));
    private static final SoundEvent U_SOUND_EVENT_1507 = SoundEvent.createVariableRangeEvent(new ResourceLocation(Additions.namespace, "1507"));
    ...
    // POIs
    public static ResourceLocation AMETHYST_LAMP_POI_RL = new ResourceLocation(Additions.namespace, "amethyst_lamp_poi");
