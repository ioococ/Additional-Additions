...
public class AdditionalSmithingTemplate extends SmithingTemplateItem {
    ...
    public static SmithingTemplateItem create(String id, List<ResourceLocation> baseSlotEmptyIcons, List<ResourceLocation> additionalSlotEmptyIcons) {
        var appliesTo = Component.translatable(Util.makeDescriptionId("item", new ResourceLocation(Additions.namespace, "smithing_template."+id+".applies_to"))).withStyle(DESCRIPTION_FORMAT);
        var upgradeDescription = Component.translatable(Util.makeDescriptionId("upgrade", new ResourceLocation(Additions.namespace, id))).withStyle(TITLE_FORMAT);
        var ingredients = Component.translatable(Util.makeDescriptionId("item", new ResourceLocation(Additions.namespace, "smithing_template."+id+".ingredients"))).withStyle(DESCRIPTION_FORMAT);
        var baseSlotDescription = Component.translatable(Util.makeDescriptionId("item", new ResourceLocation(Additions.namespace, "smithing_template."+id+".base_slot_description")));
        var additionsSlotDescription = Component.translatable(Util.makeDescriptionId("item", new ResourceLocation(Additions.namespace, "smithing_template."+id+".additions_slot_description")));
    ...
    public enum SmithingIcon {
        ...
        RING(new ResourceLocation(Additions.namespace, "item/empty_slot_ring")),
        ALLOY(new ResourceLocation(Additions.namespace, "item/empty_slot_alloy"));
