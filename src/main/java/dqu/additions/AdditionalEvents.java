...
import dqu.additions.misc.CreativeAdder;
...
public class AdditionalEvents {
    ...
    @Mod.EventBusSubscriber(modid = Additions.namespace, bus = Mod.EventBusSubscriber.Bus.FORGE, value = Dist.CLIENT)
    ...
    public static class ClientRegisterEvents {
        ...
        public static void registerGuiOverlays(RegisterGuiOverlaysEvent event) {
            event.registerAboveAll("additionalspyglass", (gui, mStack, partialTicks, screenWidth, screenHeight) -> {
                ...
                if (Additions.zoom) {
                    gui.renderSpyglassOverlay(mStack, (float) Additions.spyglassOverlay);
                }
            });
        }
    }

    @Mod.EventBusSubscriber(modid = Additions.namespace, bus = Mod.EventBusSubscriber.Bus.FORGE)
    ...
    @Mod.EventBusSubscriber(modid = Additions.namespace, bus = Mod.EventBusSubscriber.Bus.MOD)
