...
public class AdditionalLootModifier extends LootModifier {
    ...
    public AdditionalLootModifier(LootItemCondition[] conditionsIn) {
        ...
        register(List.of(BuiltInLootTables.BURIED_TREASURE, BuiltInLootTables.DESERT_PYRAMID_ARCHAEOLOGY, BuiltInLootTables.IGLOO_CHEST, BuiltInLootTables.PILLAGER_OUTPOST, BuiltInLootTables.SHIPWRECK_TREASURE, BuiltInLootTables.SHIPWRECK_SUPPLY, BuiltInLootTables.SHIPWRECK_TREASURE, BuiltInLootTables.SNIFFER_DIGGING, BuiltInLootTables.UNDERWATER_RUIN_SMALL, BuiltInLootTables.UNDERWATER_RUIN_BIG, BuiltInLootTables.VILLAGE_WEAPONSMITH, BuiltInLootTables.VILLAGE_TOOLSMITH, BuiltInLootTables.VILLAGE_ARMORER), () -> Config.getBool(ConfigValues.ROSE_GOLD), LootPool.lootPool()
                .setRolls(ConstantValue.exactly(1))
                .when(LootItemRandomChanceCondition.randomChance(0.32f))
                .add(LootItem.lootTableItem(AdditionalRegistry.ROSE_GOLD_UPGRADE.get()))
        );
        register(List.of(BuiltInLootTables.BASTION_BRIDGE, BuiltInLootTables.BASTION_HOGLIN_STABLE, BuiltInLootTables.BASTION_TREASURE, BuiltInLootTables.BASTION_OTHER, BuiltInLootTables.NETHER_BRIDGE, BuiltInLootTables.PIGLIN_BARTERING, BuiltInLootTables.RUINED_PORTAL, BuiltInLootTables.SNIFFER_DIGGING), () -> Config.getBool(ConfigValues.GILDED_NETHERITE, "enabled"), LootPool.lootPool()
                .setRolls(ConstantValue.exactly(1))
    ...
    private static void postInit() {
        Additions.LOGGER.info("[" + Additions.namespace + "] Adding " + entries.size() + " loot pools");
    }
